...
let mobingoTakes = [
    ...
    'Обдурили/намахали',
    'Мене змусили',
    'Бандерівці, нацисти, фашисти',
    'НАТО',
    'США',
    'Референдум',
    'Я не стріляв (мяу-мяу)',
    'Тут нам мема шо робити',
    'Ми маленька пилюка, ми нічого не вирішуємо',
    'Я не голосував/голосував за Пиню',
    'Чмобік зібрав хібаробінго',
    'Виглядає на 10 років старше за свій вік',
    '1+ ходка на зону',
    'Державний переворот',
    'Захист Бамбасу',
    'Братські народи/мишібратья',
    ...
    'Не знає за що воює',
    'Пішов за гроші',
    'Сидить з похмурим ебалом',
    'Винен захід/спровокували/не залишили вибору',
    'Усієї правди ми не знаємо',
    'Совкойоб',
    'Боїться ФСБшників/представників влади',
    'Його нікуди не відпускали, сам пішов',
    'Перевзування в повітрі',
    'Родичі відхрестилися від хлопчика у трусиках'
]
